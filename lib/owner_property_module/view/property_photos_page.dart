      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            widget.fromPropertyDetails && widget.photosList.isNotEmpty
                ? Container(
                            ...
                            Positioned(
                              child: GestureDetector(
                                onTap: () async{
                                  ...
                                  int status=await _viewModel.deletePropPics(picId: widget.photosList[index].id.toString());
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                onPressed: () async{
                  ...
                  int data = await _viewModel.uploadPropPics(propId: widget.propId, imageList: imageList);
                  Navigator.of(context).pop();
                  log(data.toString());
                  if (data == 200) {
