                                    ...
                                    child: GestureDetector(
                                      ...
                                      child: Material(
                                        ...
                                        child: Container(
                                            ...
                                            height: _mainHeight*0.03,
                                            padding: EdgeInsets.only(left: _mainWidth*0.01,right: _mainWidth*0.01),
                                            child: Text(
                                              " Check In ",
                                              style: TextStyle(
                                                  color: Colors.white),
                                ...
                                _gridInput(
                                    hint: value.myStayDetailsModel?.data?.agreementStatus != null &&
                                        ...
                                        : nullCheck(
                                            ...
                                            : 'Agreement Sign',
                                    icon:
                                        value.myStayDetailsModel?.data?.agreementStatus != null &&
                                                value.myStayDetailsModel?.data
                                                        ?.agreementStatus ==
                                                    '1'
                                            ? Icon(
                                    ...
                                    callBack: value.myStayDetailsModel?.data?.agreementStatus != null &&
                                            value.myStayDetailsModel?.data
                                                    ?.agreementStatus ==
                                                '1'
                                        ? () async {
